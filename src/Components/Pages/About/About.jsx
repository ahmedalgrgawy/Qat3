import App from "../../../assets/App Video/App.mp4";
...
export default function About() {
    return (
        <div>
            ...
            <div className="container flex-wrap flex justify-around items-center mb-20 mx-auto">
                <div className="md:w-[100%] lg:w-[35%] mx-auto">
                    <img src={logos.logoOne} alt="Qat3" />
                </div>
                <div className=" md:w-[100%] lg:w-[65%] p-10">
            ...
            <div className="container flex flex-col items-center justify-center my-10 text-center" >
                ...
                <div className="w-[75%] lg:w-[50%]">
                    <video loop autoPlay src={App} alt="App" className=" w-[100%]" />
                </div>
