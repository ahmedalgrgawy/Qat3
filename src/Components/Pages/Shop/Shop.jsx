            ...
            <div>
                <div className="container text-center">
                    <div className="products flex justify-between flex-wrap">
                        <div className="product mt-14 w-[23%] min-w-60 py-2 px-3 border border-main-darker rounded-3xl cursor-pointer shadow-2xl my-[15px] mx-0 duration-300 ease-in-out relative hover:scale-105">
